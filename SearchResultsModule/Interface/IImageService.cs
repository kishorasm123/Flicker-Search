...
namespace SearchResultsModule
{
    ...
    {
        /// <summary>
        /// This method performs image search operation and returns the search results.
        /// </summary>
        ...
        /// <exception cref="ImageServiceException">This exception is thrown when any error occurred while performing search operation.</exception>
        /// <exception cref="ArgumentNullException">This error is thrown if the image serach text is null or whitespaces.</exception>
        Task<List<Image>> ImageSearch(string imageSearchText, int pageNo=-1);
    }
}
